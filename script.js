...
const copiadoSucesso = document.querySelector("#copiado-sucesso")

// Função que vai gerar o CPF 
function gerarCPF() {
...
function copiarCPF() {
 ...
 navigator.clipboard.writeText(cpf).then(()=> {
    copiadoSucesso.innerText = "Copiado com sucesso!"
 },(err)=>{     
    copiadoSucesso.classList.add('error-message')
 })
}
